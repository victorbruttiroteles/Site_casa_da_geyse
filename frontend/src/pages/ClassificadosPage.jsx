        ...
        <div className="bg-navy-800 py-8 border-b border-navy-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-white">
              {locationLabel ? `Classificados — ${locationLabel}` : 'Classificados — Todas as Acompanhantes'}
            </h1>
            <p className="text-gray-400 text-sm mt-1">
              Acompanhantes hospedadas nas unidades da Casa da Geyse em Penha e Barra Velha
            </p>
          </div>
        </div>
